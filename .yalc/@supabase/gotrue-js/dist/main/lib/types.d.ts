...
export declare type VerifyOtpParams = VerifyMobileOtpParams | VerifyEmailOtpParams | VerifyTokenHashOtpParams;
...
export interface VerifyTokenHashOtpParams {
    /** The token hash sent to the user's email address. */
    token_hash: string;
    /** The user's verification type. */
    type: EmailOtpType;
    options?: {
